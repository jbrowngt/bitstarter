...
var URL_DEFAULT = "http://tranquil-shelf-5554.herokuapp.com/";
var assertUrlExists = function (val) {return val.toString();};

var callInfo = function(result) 
...
if(require.main == module) 
{
    program
        ...
        .option('-u, --url <url>', 'http://tranquil-shelf-5554.herokuapp.com', URL_DEFAULT)
        .parse(process.argv);
  if(program.url)
  {
    rest.get(program.url).on('complete', function(result)
    {
      fs.writeFileSync("urlresult.html", result); //Added this line
      var outfile = "urlresult.txt";
